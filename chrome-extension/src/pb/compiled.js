...
$root.tab = (function() {
    ...
    tab.ClientConfig = (function() {

        /**
         * Properties of a ClientConfig.
         * @memberof tab
         * @interface IClientConfig
         * @property {string|null} [name] ClientConfig name
         * @property {string|null} [uid] ClientConfig uid
         * @property {string|null} [url] ClientConfig url
         */
         ...
         * @constructor
         * @param {tab.IClientConfig=} [properties] Properties to set
         */
         ...
         * @static
         * @param {tab.IClientConfig=} [properties] Properties to set
         * @returns {tab.ClientConfig} ClientConfig instance
         */
         ...
         * @memberof tab.ClientConfig
         * @static
         * @param {tab.IClientConfig} message ClientConfig message or plain object to encode
         * @param {$protobuf.Writer} [writer] Writer to encode to
         * @returns {$protobuf.Writer} Writer
         */
         ...
         * @param {$protobuf.Reader|Uint8Array} reader Reader or buffer to decode from
         * @param {number} [length] Message length if known beforehand
         * @returns {tab.ClientConfig} ClientConfig
         * @throws {Error} If the payload is not a reader or valid buffer
         * @throws {$protobuf.util.ProtocolError} If required fields are missing
         */
        ClientConfig.decode = function decode(reader, length) {
            if (!(reader instanceof $Reader))
                reader = $Reader.create(reader);
            var end = length === undefined ? reader.len : reader.pos + length, message = new $root.tab.ClientConfig();
            while (reader.pos < end) {
                var tag = reader.uint32();
                switch (tag >>> 3) {
                case 1: {
        ...
        ClientConfig.fromObject = function fromObject(object) {
            if (object instanceof $root.tab.ClientConfig)
                return object;
            var message = new $root.tab.ClientConfig();
            if (object.name != null)
                message.name = String(object.name);
            if (object.uid != null)
                message.uid = String(object.uid);
         ...
         * @memberof tab.ClientConfig
         * @static
         * @param {tab.ClientConfig} message ClientConfig
         * @param {$protobuf.IConversionOptions} [options] Conversion options
         * @returns {Object.<string,*>} Plain object
         */
        ...
        ClientConfig.getTypeUrl = function getTypeUrl(typeUrlPrefix) {
            ...
            return typeUrlPrefix + "/tab.ClientConfig";
        };
