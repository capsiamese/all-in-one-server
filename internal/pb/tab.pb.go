...
func (x *BarkHistory) GetTitle() string {
	if x != nil {
		return x.Title
	}
	return ""
...
func (x *BarkHistory) GetContent() string {
	if x != nil {
		return x.Content
	}
	return ""
...
func (x *BarkHistory) GetParams() map[string]string {
	if x != nil {
		return x.Params
	}
	return nil
...
var file_tab_proto_rawDesc = []byte{
	...
	0x67, 0x72, 0x6f, 0x75, 0x70, 0x73, 0x22, 0xf4, 0x01, 0x0a, 0x0b, 0x42, 0x61, 0x72, 0x6b, 0x48,
	...
	0x70, 0x61, 0x72, 0x61, 0x6d, 0x73, 0x18, 0x07, 0x20, 0x03, 0x28, 0x0b, 0x32, 0x1c, 0x2e, 0x74,
	0x61, 0x62, 0x2e, 0x42, 0x61, 0x72, 0x6b, 0x48, 0x69, 0x73, 0x74, 0x6f, 0x72, 0x79, 0x2e, 0x50,
