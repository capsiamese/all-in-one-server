...
// TabQuery is the builder for querying Tab entities.
...
// Where adds a new predicate for the TabQuery builder.
func (tq *TabQuery) Where(ps ...predicate.Tab) *TabQuery {
	tq.predicates = append(tq.predicates, ps...)
	return tq
}

// Limit adds a limit step to the query.
func (tq *TabQuery) Limit(limit int) *TabQuery {
	tq.limit = &limit
	return tq
}

// Offset adds an offset step to the query.
func (tq *TabQuery) Offset(offset int) *TabQuery {
	tq.offset = &offset
	return tq
}
...
func (tq *TabQuery) Unique(unique bool) *TabQuery {
	tq.unique = &unique
	return tq
}

// Order adds an order step to the query.
func (tq *TabQuery) Order(o ...OrderFunc) *TabQuery {
	tq.order = append(tq.order, o...)
	return tq
}

// QueryGroup chains the current query on the "group" edge.
func (tq *TabQuery) QueryGroup() *GroupQuery {
	...
	query.path = func(ctx context.Context) (fromU *sql.Selector, err error) {
		...
		step := sqlgraph.NewStep(
			sqlgraph.From(tab.Table, tab.FieldID, selector),
...
// First returns the first Tab entity from the query.
// Returns a *NotFoundError when no Tab was found.
func (tq *TabQuery) First(ctx context.Context) (*Tab, error) {
	nodes, err := tq.Limit(1).All(ctx)
	if err != nil {
		return nil, err
	}
	if len(nodes) == 0 {
		return nil, &NotFoundError{tab.Label}
	}
	return nodes[0], nil
}

// FirstX is like First, but panics if an error occurs.
func (tq *TabQuery) FirstX(ctx context.Context) *Tab {
...
// FirstID returns the first Tab ID from the query.
// Returns a *NotFoundError when no Tab ID was found.
func (tq *TabQuery) FirstID(ctx context.Context) (id int, err error) {
	var ids []int
...
func (tq *TabQuery) FirstIDX(ctx context.Context) int {
...
// Only returns a single Tab entity found by the query, ensuring it only returns one.
// Returns a *NotSingularError when more than one Tab entity is found.
// Returns a *NotFoundError when no Tab entities are found.
func (tq *TabQuery) Only(ctx context.Context) (*Tab, error) {
	...
	case 0:
		return nil, &NotFoundError{tab.Label}
	default:
		return nil, &NotSingularError{tab.Label}
	}
}

// OnlyX is like Only, but panics if an error occurs.
func (tq *TabQuery) OnlyX(ctx context.Context) *Tab {
...
// OnlyID is like Only, but returns the only Tab ID in the query.
// Returns a *NotSingularError when more than one Tab ID is found.
// Returns a *NotFoundError when no entities are found.
func (tq *TabQuery) OnlyID(ctx context.Context) (id int, err error) {
	var ids []int
	...
	case 0:
		err = &NotFoundError{tab.Label}
	default:
		err = &NotSingularError{tab.Label}
	}
	return
}

// OnlyIDX is like OnlyID, but panics if an error occurs.
func (tq *TabQuery) OnlyIDX(ctx context.Context) int {
...
// All executes the query and returns a list of Tabs.
func (tq *TabQuery) All(ctx context.Context) ([]*Tab, error) {
	if err := tq.prepareQuery(ctx); err != nil {
		return nil, err
	}
...
func (tq *TabQuery) AllX(ctx context.Context) []*Tab {
...
// IDs executes the query and returns a list of Tab IDs.
func (tq *TabQuery) IDs(ctx context.Context) ([]int, error) {
	var ids []int
	if err := tq.Select(tab.FieldID).Scan(ctx, &ids); err != nil {
		return nil, err
	}
	return ids, nil
}
...
func (tq *TabQuery) IDsX(ctx context.Context) []int {
	ids, err := tq.IDs(ctx)
	if err != nil {
		panic(err)
	}
...
func (tq *TabQuery) Count(ctx context.Context) (int, error) {
	if err := tq.prepareQuery(ctx); err != nil {
		return 0, err
	}
...
func (tq *TabQuery) CountX(ctx context.Context) int {
...
func (tq *TabQuery) Exist(ctx context.Context) (bool, error) {
	if err := tq.prepareQuery(ctx); err != nil {
		return false, err
	}
...
func (tq *TabQuery) ExistX(ctx context.Context) bool {
...
// Clone returns a duplicate of the TabQuery builder, including all associated steps. It can be
// used to prepare common query builders and use them differently after the clone is made.
func (tq *TabQuery) Clone() *TabQuery {
	if tq == nil {
		return nil
	}
	return &TabQuery{
		...
		predicates: append([]predicate.Tab{}, tq.predicates...),
...
func (tq *TabQuery) WithGroup(opts ...func(*GroupQuery)) *TabQuery {
	query := &GroupQuery{config: tq.config}
...
func (tq *TabQuery) sqlAll(ctx context.Context) ([]*Tab, error) {
	...
	if query := tq.withGroup; query != nil {
		...
		nodeids := make(map[int][]*Tab)
		for i := range nodes {
			if nodes[i].group_tabs == nil {
				continue
			}
			fk := *nodes[i].group_tabs
		...
		for _, n := range neighbors {
			...
			if !ok {
				return nil, fmt.Errorf(`unexpected foreign-key "group_tabs" returned %v`, n.ID)
			}
			for i := range nodes {
...
func (tq *TabQuery) sqlCount(ctx context.Context) (int, error) {
	_spec := tq.querySpec()
...
func (tq *TabQuery) sqlExist(ctx context.Context) (bool, error) {
...
func (tq *TabQuery) querySpec() *sqlgraph.QuerySpec {
...
func (tq *TabQuery) sqlQuery(ctx context.Context) *sql.Selector {
	builder := sql.Dialect(tq.driver.Dialect())
	t1 := builder.Table(tab.Table)
	columns := tq.fields
	if len(columns) == 0 {
		columns = tab.Columns
	}
...
func (tgb *TabGroupBy) Aggregate(fns ...AggregateFunc) *TabGroupBy {
	tgb.fns = append(tgb.fns, fns...)
	return tgb
}

// Scan applies the group-by query and scans the result into the given value.
func (tgb *TabGroupBy) Scan(ctx context.Context, v interface{}) error {
...
func (tgb *TabGroupBy) sqlQuery() *sql.Selector {
...
func (ts *TabSelect) Scan(ctx context.Context, v interface{}) error {
